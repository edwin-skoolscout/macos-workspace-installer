...
# Skips what a container cannot provide: GitHub auth, private repos, /etc/hosts + mkcert,
# and the project installs that need the private registries.
set -euo pipefail
cd "$(dirname "${BASH_SOURCE[0]}")/.."

SKIPS="github-auth,clone-repos,project-deps,local-dev-wiring"
